...
#         USAGE: ./status.bash
#
#   DESCRIPTION: Functions to display the SysV init style running status
#
#       OPTIONS: ---
#  REQUIREMENTS: Intended to be sourced into other shell scripts.  No input, no output.
#          BUGS: ---
#         NOTES: ---
#        AUTHOR: Kirk L. Roybal (DBRE), kirk.roybal@doordash.com
#  ORGANIZATION: OmniTI/Credativ/Instaclustr/Doordash
#       CREATED: 04/05/2021 18:17:25
#      REVISION:  ---
#===============================================================================
...
#---  FUNCTION  ----------------------------------------------------------------
#          NAME:  maybe_exit
#   DESCRIPTION:  Prompt the user to proceed in spite of errors
#    PARAMETERS:  none
...
function __umount_loopback_loop() {
...
function key_is_random() {
    [ "$1" = "/dev/urandom" -o "$1" = "/dev/hw_random" \
	-o "$1" = "/dev/random" ]
}

function find_crypto_mount_point() {
...
#---  FUNCTION  ----------------------------------------------------------------
#          NAME:  logdate
#   DESCRIPTION: format a date suitable for prepending in a log
#    PARAMETERS:  none
#       RETURNS:  todays date to the second in iso format
#-------------------------------------------------------------------------------
